  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center font-sans overflow-hidden">
      <div className="flex min-h-screen items-center justify-center bg-[#588157]">
        <div className="bg-[#DAD7CD] rounded-[30px] py-[50px] px-10 w-full max-w-[400px] shadow-[0_10px_40px_rgba(0,0,0,0.2)]">
          ...
          <div className="flex flex-col gap-[14px]">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-3 w-full py-[14px] rounded-full border-2 border-[#dadce0] bg-white text-[#3c4043] font-bold text-[15px] cursor-pointer shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-shadow duration-200 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-3 w-full py-[14px] rounded-full border-2 border-[#e8761b] bg-white text-[#e8761b] font-bold text-[15px] cursor-pointer shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-shadow duration-200 disabled:cursor-not-allowed"
            >
              <svg
                width="22"
                height="22"
