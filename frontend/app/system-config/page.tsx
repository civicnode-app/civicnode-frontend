...
import { systemConfigSchema, type SystemConfigInput } from "@/lib/validation";

export default function SystemConfigPage() {
  const [configForm, setConfigForm] = useState<SystemConfigInput>({
    resolution: "1080p",
    frameRate: 30,
    detectionMode: "auto",
    snapshotInterval: 5,
  ...
  const handleConfigSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const validation = systemConfigSchema.safeParse(configForm);
    if (!validation.success) {
      setConfigMessage(
        validation.error.issues[0]?.message ?? "Konfigurasi tidak valid.",
      );
      return;
    }

    // Payload sudah valid dan aman untuk dikirim ke backend.
    setConfigMessage("Konfigurasi valid dan siap dikirim ke backend.");
  };
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", width: "100%" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ lineHeight: "1.3" }}>
              <p style={{ fontWeight: "800", margin: 0, fontSize: "14px" }}>
                ATUN
              </p>
        ...
        <section className="cfg-card" style={{ padding: "24px" }}>
          <p className="cfg-section-label">VALIDATE CONFIG PAYLOAD</p>
          <form
          ...
          >
            ...
            >
              ...
              <select
                ...
                onChange={(event) =>
                  updateConfigForm("resolution", event.target.value)
                }
                style={{
                  borderRadius: "10px",
            ...
            >
              Frame Rate (FPS)
              <select
                value={configForm.frameRate}
                onChange={(event) =>
                  updateConfigForm("frameRate", Number(event.target.value))
                }
                style={{
                  borderRadius: "10px",
                  border: "1px solid #d0d5dd",
            ...
            >
              Detection Mode
              <select
                value={configForm.detectionMode}
                onChange={(event) =>
                  updateConfigForm("detectionMode", event.target.value)
                }
                style={{
                  borderRadius: "10px",
                  border: "1px solid #d0d5dd",
                  ...
                  >
                    ...
                    <div
                      style={{
                        width: "36px",
                        height: "20px",
                        backgroundColor: item.on ? "#588157" : "#ccc",
                        borderRadius: "10px",
                        position: "relative",
                        cursor: "pointer",
          ...
          >
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: "12px",
                        fontWeight: "800",
                        color: row.value === "v1.0.0" ? "#588157" : "#333",
                      }}
                    >
                      {row.value}
                    </span>
            ...
            <div className="cfg-card" style={{ padding: "24px" }}>
              ...
              >
                ...
                <p
                  style={{ margin: "4px 0 0", fontSize: "11px", color: "#666" }}
                >
                  Last TX: 1 min ago
                </p>
              </div>
