...
import { AlertTriangle, MapPin, Search, ChevronRight, CheckCircle2, Video, Wifi, WifiOff } from "lucide-react";
...
export default function ZoneTriageList() {
  ...
  const sortedZones = useMemo(() => [...zones].sort((a, b) => a.score - b.score), [zones]);
    ...
    <div className="flex flex-col gap-5 w-full">
      ...
      <div className="flex justify-between items-end">
        ...
        <div className="bg-white/10 p-2 px-4 rounded-full flex items-center gap-2">
          ...
          <span className="text-white text-xs font-bold">{DUMMY_CAMERAS.filter(c => c.status).length} Active AI Nodes</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
        {sortedZones.map((zone) => {
          ...
          const accentColor = isCritical ? "#ef4444" : isWarning ? "#f59e0b" : "#22c55e";
          const zoneCameras = DUMMY_CAMERAS.filter(c => c.zone_id === zone.id);
                ...
                <div className="flex flex-col p-5 flex-[2] border-r border-slate-100">
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between items-end mb-1.5">
                      ...
                      <span className="font-black text-lg leading-none" style={{ color: accentColor }}>{zone.score}%</span>
                    </div>
                  ...
                  <div className="relative w-full h-24 bg-slate-100 rounded-2xl mb-4 overflow-hidden group/thumb flex-shrink-0">
                    <Image
                ...
                <div className="flex flex-col p-5 flex-[1.5] bg-slate-50/60 min-w-0">
                  ...
                  {zoneCameras.length === 0 ? (
                    <div className="flex-1 flex items-center justify-center">
                      <p className="text-slate-300 text-xs font-bold text-center">Belum ada kamera</p>
                    </div>
                  ) : (
